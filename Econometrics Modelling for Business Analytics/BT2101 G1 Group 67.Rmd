...
<span style="color: blue;"> For types of fast food chains, different types of fast food chains (`chain`) have a different pricing, and different areas have preference for different fast food chains which leads to uneven distribution of fast food chains. Without taking into account these food chains and fixating on only one of them, we are unable to conclude that there is a relationship between price of soda and proportion of black residents. </span>
